    ...
    <div className=' bg-navBg text-white'>
      ...
      <div className='container mx-auto xl:flex items-center justify-between hidden'>
        ...
        <Link href={'#'} className='font-medium flex items-center gap-1 relative group h-full py-5 duration-200 ease-in-out'>Products <FaAngleDown />
          ...
          <ul className='absolute left-0 top-16  bg-gray-400 w-72 p-3 flex flex-col gap-5 rounded-b-md invisible  group-hover:visible'>
            <li>Forklift</li>
            <li>Warehouse Equipment</li>
            <li>Material Handling Equipment</li>
            <li>Lifts & Cranes</li>
            <li>Construction Equipment</li>
            <li>Lithium Powered Equipment</li>
            <li>Others</li>
          </ul>

        </Link>
        <Link href={'#'} className='font-medium flex items-center gap-1 py-5'>Tires, Wheels & Rim <FaAngleDown /> </Link>
        <Link href={'#'} className='font-medium flex items-center gap-1 py-5'>Batteries <FaAngleDown /> </Link>
        <Link href={'#'} className='font-medium flex items-center gap-1 py-5'>Racking & Furniture <FaAngleDown /> </Link>
        <Link href={'#'} className='font-medium flex items-center gap-1 py-5'>Spare & Service <FaAngleDown />
        </Link>
        <Link href={'#'} className='font-medium flex items-center gap-1 py-5' >Rental <FaAngleDown /> </Link>
      </div>
