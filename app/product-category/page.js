    ...
    const productList = [
        {
            ...
            "product_content" : "These 4-wheel electric forklifts is ready to face some of the most difficult material handling tasks. Max-8 series is your […]"
        },
        {
            "product_image" : product3,
            "Product_title" : "1.5T Three Wheel Electric Forklift",
            "product_content" : "EP introduces a compact and agile 3-wheel Li-ion forklift truck for the rapid turnover of goods in confined space with […]"
        },
        {
            "product_image" : product4,
            "Product_title" : "7.0-10.0T Lithium Powered Electric Forklift",
            "product_content" : "EFL Series releases a new generation, EFL702/1002 7.0/10.0Ton Li-ion electric forklift, to fill the vacancy of large ton and send […]"
        },
        {
            "product_image" : product5,
            "Product_title" : "LPG/Gasoline Forklift – 2.5T",
            "product_content" : "Introduction EQUIPMAX 2.5T Cushion Tires LPG forklift adopts the newest technologies and ergonomic concepts in designing and manufacturing. The forklift […]"
        },
        {
            "product_image" : product6,
            "Product_title" : "Telescopic Forklift 2WD/4WD – 2.5-4.0T",
            "product_content" : "Introduction: The EQUIPMAX telescopic forklift (telehandler) adopts the latest technologies and ergonomic concepts in designing and manufacturing. The forklift with […]"
        },
        {
            ...
            <div className='container mx-auto px-3 md:px-0 py-10'>
                ...
                <div className='py-16 flex flex-col items-start justify-center gap-10'>

                    {
                        ...
                        <Image width={300} height={300} src={product.product_image} className='md:w-80 md:h-80 object-cover'></Image>
                        <div>
                            <h1 className='md:text-3xl text-2xl mt-4 font-semibold'> {product.Product_title} </h1>
